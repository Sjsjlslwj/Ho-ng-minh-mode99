...
ImageButton1.Image = "http://www.roblox.com/asset/?id=16697806775"
...
function Update:Window(text,logo,keybind)
    ...
    BtnStroke.Color = Color3.fromRGB(217, 31, 82)
	...
	Logo.Image = "rbxassetid://15174812758"
    ...
    function uitab:AddTab(text,img)
        ...
        local title = Instance.new("cơm cà ri v2")
        local TUICorner = Instance.new("UICorner")
        local Title = Instance.new("Hoàng Minh")
    ...
    function main:AddButton(text, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        ImageButton.Image = "rbxassetid://15174812758"
        ...
        Space.TextColor3 = Color3.fromRGB(217, 31, 82)
        Space.TextXAlignment = Enum.TextXAlignment.Right

        Black.Name = "Black"
        Black.Parent = Button
        Black.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        UIStroke.Color = Color3.fromRGB(217, 31, 82)
        ...
        ImageLabel.Image = "rbxassetid://15174812758"
        ...
        if default == true then
            ...
            game.TweenService:Create(
                ...
                {ImageColor3 = Color3.fromRGB(217, 31, 82)}
            ):Play()
            toggle = not toggle
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderFrame.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        ImageLabel.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ImageLabel.BackgroundTransparency = 1.000
        ImageLabel.BorderSizePixel = 0
        ...
        SliderInput.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        SliderButton.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        SliderCount.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        Title_2.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        SliderStroke.Color = Color3.fromRGB(217, 31, 82)
        ...
        BoxFrame.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        Textbox.BackgroundColor3 = Color3.new(217, 31, 82)
        ...
        txtbtn.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        RealTextbox.Text = ""
        RealTextbox.TextColor3 = Color3.fromRGB(217, 31, 82)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        TextboxLabel.Name = "TextboxLabel"
        TextboxLabel.Parent = Textbox
        TextboxLabel.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        TextboxLabel.BackgroundTransparency = 1.000
        TextboxLabel.Position = UDim2.new(0, 15, 0, 0)
        TextboxLabel.Text = text
        TextboxLabel.Size = UDim2.new(0, 145, 0, 31)
    ...
    function main:Dis(text,display)
        ...
        Labeld.TextColor3 = Color3.fromRGB(217, 31, 82)
    ...
    function main:AddSeperator(text)
        ...
        Seperator.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        Seperator.BackgroundTransparency = 1.000
        Seperator.Size = UDim2.new(0, 310, 0, 20)

        Sep1.Name = "Sep1"
        Sep1.Parent = Seperator
        Sep1.BackgroundColor3 = Color3.new(217, 31, 82)
        ...
        Sep2.BackgroundColor3 = Color3.fromRGB(217, 31, 82)
        ...
        Sep3.BackgroundColor3 = Color3.new(217, 31, 82)
            ...
            for i,v in pairs(Site.data) do
                ...
                if tonumber(v.maxPlayers) > tonumber(v.playing) then
                    ...
                    if Possible == true then
                        ...
                        pcall(function()
                            wait()
                            game:GetService("đếnService"):TeleportToPlaceInstance(PlaceID, ID, game.Players.LocalPlayer)
                        end)
                        wait(4)
                    end
                end
                ...
                if IslandESP then 
                    if v.Name ~= "Sea" then
                        if not v:FindFirstChild('NameEsp') then
                            ...
                            name.TextColor3 = Color3.fromRGB(217, 31, 82)
                        else
				...
				if ESPPlayer then
					if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
						...
						if v.Team == game.Players.LocalPlayer.Team then
							name.TextColor3 = Color3.new(217, 31, 82)
						else
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if v:FindFirstChild('HumanoidRootPart') then
                        if not v:FindFirstChild("MobEap") then
                            ...
                            TextLabel.TextColor3 = Color3.fromRGB(217, 31, 82)
...
local posX = 10
    ...
    spawn(function()
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.Tweenfruit or _G.TeleportNPC or _G.AutoKai or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIsland or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRace or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or _G.Namfon or _G.AutoSwordMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.TPB or _G.Farmfast or _G.AutoRace or _G.RaidPirate or Open_Color_Haki or _G.AutoTerrorshark == true then
...
local Library = Update:Window("Min XT Hub","",Enum.KeyCode.RightControl);
local Main = Library:AddTab("Chính","13075651575")
local Bone = Library:AddTab("Chính 2","13075651575")
local M = Library:AddTab("vật Phẩm","13075622619")
...
local R = Library:AddTab("Tập Kích","11155986081")
...
local Misc = Library:AddTab("Khác","11156061121")
    ...
    spawn(function()
        while wait() do
            if _G.BuyAllSword then
                pcall(function()
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Cutlass")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Katana")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Iron Mace")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Duel Katana")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Triple Katana")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Pipe")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Bisento")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Dual-Headed Blade")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Soul Cane")
                    if _G.BuyHop then
                        wait(10)
                        Hop()
                    end
...
Main:AddToggle("nhặt rương trên đảo bí ẩn",false,function(value)
...
Main:AddToggle("đổi máy chủ",_G.AutoFarmChest_Hop,function(value)
    _G.AutoFarmChest_Hop = value
    end)

    
local ListC = {"thường", "nhiệm vụ"}
CakeFMode = "thường"

Bone:AddDropdown("chế độ",ListC,function(value)
    CakeFMode = value
end)


    
    Bone:AddToggle("cày tư lệnh bột",_G.AutoDoughtBoss,function(value)
    ...
    spawn(function()
        while wait() do
            if CakeFMode == "thường" and _G.AutoDoughtBoss then
                pcall(function()
...
spawn(function()
        while wait() do
            if CakeFMode == "nhiệm vụ" and _G.AutoDoughtBoss and World3  then
                pcall(function()
    ...
    spawn(function()
        while wait() do
            if CakeFMode == "nhiệm vụ" and _G.AutoDoughtBoss and World3 and not game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince")  then
                pcall(function()
                    local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
    ...
    Bone:AddToggle("tự động triệu hồi",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
   

    local MobKilled = Bone:AddLabel("")
...
Main:AddToggle("đánh tự động [auto click]",false,function(value)
_G.AutoClick = value
end)

Main:AddToggle("tắt hết thông báo",false,function(NamfonGay)
...
Main:AddToggle("tắt dame [remove dame text]",false,function(Remo)
...
Main:AddToggle("màn hình đen [tăng fps]",false,function(Umm)
...
spawn(function()
    ...
    Main:AddSlider("% máu",1,100,30,function(value)
...
M:AddToggle("đến đảo bí ẩn",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("láy thuyền",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
...
M:AddToggle("đến npc bán trái ác quỷ",_G.TPNPC,function(value)
             _G.Miragenpc = value
...
M:AddToggle("đến Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
            ...
            while wait() do 
                if _G.AutoSuperhuman then
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Combat") or game.Players.LocalPlayer.Character:FindFirstChild("Combat") and game:GetService("Players")["LocalPlayer"].Data.Beli.Value >= 150000 then
                        ...
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaBlackLeg")
                    end   
                    ...
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw") then
                        ...
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].Data.Beli.Value >= 300000 then
                            ...
                            wait(.1)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaElectro")
                        end
                        ...
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].Data.Beli.Value >= 750000 then
                            ...
                            wait(.1)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaFishmanKarate")
                        end
                        ...
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].Data.Beli.Value >= 3000000 then
                            ...
                            wait(.1)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSuperhuman")
                        end
            ...
            if _G.AutoDeathStep then
                if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") then
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value >= 450 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaDeathStep")
        ...
        pcall(function()
            while wait() do
                if _G.AutoSharkman then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaFishmanKarate")
                    if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSharkmanKarate"), "keys") then  
                        if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Water Key") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Water Key") then
                            topos(CFrame.new(-2604.6958, 239.432526, -10315.1982, 0.0425701365, 0, -0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365))
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSharkmanKarate")
                ...
                if _G.AutoElectricClaw then
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electric Claw") then
                        if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaElectricClaw")
                    ...
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") then
                        if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 400 then
                            if _G.AutoFarm == false then
                                ...
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaElectricClaw","Start")
                                wait(2)
                                repeat task.wait()
            ...
            if _G.AutoDragonTalon then
                if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") then
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw").Level.Value >= 400 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaDragonTalon")
		...
		if _G.Auto_God_Human then
			pcall(function()
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSuperhuman",true) == 1 then
					...
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaDeathStep",true) == 1 then
					...
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSharkmanKarate",true) == 1 then
					...
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaElectricClaw",true) == 1 then
					...
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaDragonTalon",true) == 1 then
						if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value >= 400 or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon").Level.Value >= 400 then
							if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaGodhuman",true), "Bring") then
								game.StarterGui:SetCore("SendNotification", {
									Title = "Notification", 
								...
								game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaGodhuman")
							end
						end
					else
						game.StarterGui:SetCore("SendNotification", {
...
spawn(function()
    ...
    M:AddToggle("đổi máy chủ",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)
   ...
   M:AddSeperator("Misc Mastery")
    ...
    M:AddToggle("tự động thông thạo trái",_G.AutoFarmFruitMastery,function(value)
...
M:AddToggle("tự động Soul Guitar + đổi máy chủ",false,function(value)
...
M:AddToggle("tự động Tushita", _G.Autotushita,function(value)
    ...
    M:AddSeperator(" Terrorshark")
    
    M:AddToggle("tự động đánh Terrorshark", _G.AutoTerrorshark,function(value)
         _G.AutoTerrorshark = value
        StopTween( _G.AutoTerrorshark)
    end)
    
    M:AddToggle("tự động đánh Terrorshark đổi máy chủ", _G.AutoTerrorsharkhop,function(value)
    ...
    M:AddToggle("tự động boss bí ẩn",_G.AutoElitehunter,function(value)
...
local PolePos = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
    ...
    Bone:AddSeperator("Bones")
    
    BoneCheck = Bone:AddLabel("Total Bone :  ")
...
local ListB = {"thường", "nhiệm vụ"}
BoneFMode = "thường"
Bone:AddDropdown("chế độ", ListB,function(value)
    BoneFMode = value
end)

    local BoneFarm = Bone:AddToggle("tự động cày xương",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    spawn(function()
        while wait() do 
            if BoneFMode == "thường" and _G.Auto_Bone and World3 then
                pcall(function()
    ...
    spawn(function()
        while wait() do
            if  BoneFMode == "nhiệm vụ" and _G.Auto_Bone and World3  then
                pcall(function()
                    local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
    ...
    Bone:AddToggle("tự động đổi xương",_G.Auto_Random_Bone,function(value)
        _G.Auto_Random_Bone = value
    end)
    
    spawn(function()
        pcall(function()
            while wait(.000000001) do
                                ...
                                if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                    ...
                                    repeat task.wait()
                                        ...
                                        if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                            game:GetService("đếnService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                        end
...
if World3 then
    ...
    RaceV4:AddButton("đến đền",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
RaceV4:AddButton("đến cần gạt",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

RaceV4:AddButton("đên Acient One",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   

RaceV4:AddToggle("tự động Buy Gear",_G.Auto_Farm_Bone4,function(value)
...
RaceV4:AddToggle("tự động nhìn trăng",false,function(v)
  _G.AutoDooHee = v
  end)
spawn(function()
    while wait() do
  ...
  RaceV4:AddButton("đến Cyborg",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  RaceV4:AddButton("đến Fish",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("đến Ghoul",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("đến Human",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("đến Mink",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("đến angle",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)

  RaceV4:AddSeperator("tự động Trial")
  
  RaceV4:AddButton("mua gear",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
  end)
  RaceV4:AddToggle("tự động đánh người chơi trong trial",false,function(Val)
  _G.AutoKillTial = Val
  StopTween(_G.AutoKillTial)
  end)
  RaceV4:AddToggle("tự động trial",false,function(v)
  _G.AutoQuestRace = v
...
spawn(function()
 ...
 RaceV4:AddButton("tự động Angel",function(t)
    ...
    P:AddToggle("đến người chơi",false,function(value)
    ...
    R:AddToggle("gết quái",nil,function(value)
        _G.Kill_Aura = value
        end) 
...
spawn(function()
    ...
    R:AddToggle("tự động nâng v2",_G.Auto_Awakener,function(value)
 ...
 R:AddToggle("tự động Law Sword", _G.AutoOderSword,function(value)
    ...
    R:AddToggle("tự động Law Sword đổi máy chủ", _G.AutoOderSwordHop,function(value)
    ...
    T:AddButton("đến Old World",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:AddButton("đến Second Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:AddButton("đến Third Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:AddButton("đến to Seabeast",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
    ...
    T:AddToggle("đến",false,function(value)
    ...
    T:AddToggle("đến",_G.TeleportNPC,function(value)
...
S:AddToggle("tự động Buy Abilities", false, function(t)
    Abilities = t
    ...
    S:AddButton("mua Sharkman Karate [ $5,000 Fragments $2,500,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaSharkmanKarate")
    end)
    ...
    S:AddButton("Slingshot [ $5,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Slingshot")
    end)
    
    S:AddButton("Musket [ $8,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Musket")
    end)
    
    S:AddButton("Flintlock [ $10,500 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Flintlock")
    end)
    
    S:AddButton("Refined Slingshot [ $30,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Refined Flintlock")
    end)
    ...
    S:AddButton("Cannon [ $100,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("muaItem","Cannon")
    end)
...
S:AddButton("hoàn trả chỉ số", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:AddButton("Đổi tộc", function()
    ...
    D:AddToggle("tự động mua Fruit Sniper",_G.AutoBuyFruitSniper,function(value)
    ...
    D:AddButton("Random Fruit",function()
        ...
        D:AddButton("mở cửa hàng trái ác quỷ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
spawn(function()
    ...
    D:AddToggle("Nhặt Fruit",_G.Tweenfruit,function(value)
    _G.Tweenfruit = value
    ...
    Misc:AddButton("đến máy chủ ít người",function()
        ...
        if AutoTeleport then
            ...
            game:GetService("đếnService"):TeleportToPlaceInstance(game.PlaceId, goodserver)
        end
    end)
    ...
    Misc:AddTextbox("dán job id vào đây", true, function(value)
	_G.Job = value
	end)

	Misc:AddButton("vào máy chủ",function()
	game:GetService("đếnService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
	end)
	
    Misc:AddSeperator("Misc")
    
    Misc:AddButton("mở cửa hàng ác quỷ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    Misc:AddButton("mở rương",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")
        wait(1)
        game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
    end)
    
    Misc:AddButton("mở rương trái ác quỷ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
    end)
    
    Misc:AddButton("mở bảng danh hiệu",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:AddButton("mở bảng haki màu",function()
...
Misc:AddSeperator("Teams")
    ...
    Misc:AddToggle("giao diện tối giản",false,function(value)
        if value == true then
...
Misc:AddToggle("đồ hoạ cao",false,function(v)
			if v then
	...
	Misc:AddToggle("xuyên tường",false,function(value)
		NoWorld = value
	...
	Misc:AddToggle("haki cầu vòng",false,function(value)
		RainbowHaki = value
	end)

	Misc:AddToggle("yoru cầu vòng",false,function(value)
		RainbowYoru = value
	end)
...
Misc:AddToggle("không văng game [anti afk]", true, function()
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddToggle("tự động vào lại máy chủ [auto rejoin]",true,function(value)
		_G.AutoRejoin = value
	end)
	        ...
	        if _G.AutoRejoin then
	                getgenv().rejoin = game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
                        if child.Name == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
                            game:GetService("đếnService"):Teleport(game.PlaceId)
                        end
                     end)
	            end
	        end
	...
	Misc:AddToggle("khoá Level",false,function(value)
		_G.LockLevel = value
	end)
...
Misc:AddSlider("Select Level Lock Farm",1,LockLevelValue,LockLevelValue,nil,function(value)
	...
	Misc:AddToggle("khoá Beli",false,function(value)
		_G.LockBeli = value
	end)
		...
		while wait() do
			if _G.Open_LockBone then
				if Boneremote() == _G.Lock_Bone then
					game.Players.LocalPlayer:Kick("khoá Bone Success")
				end
			end
		end
	end)

	Misc:AddTextbox("khoá Beli", true, function(value)
		_G.LevelcloseBeli = value
	end)

	Misc:AddToggle("khoá F tím",false,function(value)
		_G.LockFragments = value
	end)

	Misc:AddSlider("khoá F tím",0,_G.LevelcloseFragments,_G.LevelcloseFragments,100000,function(value)
	...
	Misc:AddToggle("khoá Bone",false,function(vv)
		_G.Open_LockBone = vv
	end)

	Misc:AddSlider("khoá Bone",1,5000,100,_G.Lock_Bone,_G.Lock_Bone,function(value)
		_G.Lock_Bone = value
	end)
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    Misc:AddButton("bẻ khoá giới hạn zoom màn hình", function()
		while wait() do
...
Misc:AddButton("hiển thị vật phẩm [show items]", function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("mua"..v,true) == 1 then 
    ...
    Misc:AddButton("tool dịch chuyển [tp tool]",function()
    ...
    Misc:AddButton("dừng bay",function()
        topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Clip = false
    end)
    ...
    Misc:AddSeperator("grafic")

    
    Misc:AddButton("tăng fps [fps boost]",function()
        pcall(function()
    ...
    Misc:AddButton("xoá xương mù [remove fog]",function(qww)
...
Misc:AddToggle("ESP đảo",IslandESP,function(value)
    ...
    Misc:AddToggle("tự động Active Race",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("tự động Use Awakening",_G.AutoAwakeningRace,function(value)
